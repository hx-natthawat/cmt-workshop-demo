...
## อัปเดตเด็คหลัก (Comprehensive Edition — ล่าสุด)

เด็คหลักรวมเป็นฉบับเต็มวัน **81 สไลด์** อยู่ที่ `decks/AI_for_MarTech_Workshop_HTML_Deck.html` (เปิดจากโฟลเดอร์นี้ได้เลย ใช้ offline ได้ ยกเว้นสไลด์ Slido)

### สิ่งที่เพิ่มจากเวอร์ชันก่อน

- **Slido ฝังสด 4 จุด**: #3 Check-in (QR + จอผลในสไลด์เดียว) · #4 จอผลโหวต (ซ่อน — กด O เรียก) · #32 โพลเปิดบ่าย · #71 Feedback ปิดวัน — ตั้งค่าโพลทั้งหมดตาม `decks/Slido_Polls_Setup.md` (งาน D-3)
- **กิจกรรมในเด็ค**: AI or Not คลิกเฉลย (#8) · ตัวเลขเบลอทายก่อนเฉลย (#15) · ป้ายถามห้อง 9 จุด
- **บล็อก Agent จาก ByteByteGo**: ลูป → 5 Patterns → ทำไมพังใน Production → Autonomy Spectrum → 4 หลักปฏิบัติ (เจาะ 4 ภาพ) → Debate → แผน 30 วัน
- **AI Architecture & Databases** หลังจบ Build — ตอบ "Claude ควรใช้ DB แบบไหน" ก่อนเข้า Capstone
- คีย์ลัดใหม่: **Shift+H** เปิดสไลด์ที่ซ่อนทั้งหมดชั่วคราว (C-R-T-F, Lab 1 ฯลฯ ที่ซ้ำกับ Week 3)

### เช็คก่อนวันงาน (เพิ่มจาก smoke-test)

- [ ] เปิดเด็คแล้วกดผ่านทุกสไลด์ 1 รอบ (ลูกศรขวาค้างได้)
- [ ] ทดสอบสแกน QR ทั้งสองบนจอโปรเจกเตอร์จริง (#2 เอกสาร, #3 Slido)
- [ ] สร้างโพลใน Slido ครบตาม Slido_Polls_Setup.md แล้วซ้อม activate + กด O สลับจอผล
- [ ] ซ้อมคลิกเฉลย AI or Not และคลิกตัวเลขสไลด์สถิติ (คลิกที่ตัว element — คลิกที่ว่างคือเปลี่ยนสไลด์)
